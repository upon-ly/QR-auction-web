...
EVERY COIN NEEDS A CULT.`);
    const embedUrl = encodeURIComponent(`https://qrcoin.fun/85`);
    ...
    const quoteCastUrl = "https://farcaster.xyz/qrcoindotfun/0x99af7d4c"; // Empty for now, add a real URL when needed
    if (quoteCastUrl) {
