...
export function LinkVisitClaimPopup({ 
  ...
  const handleShare = async () => {
    const shareText = encodeURIComponent(`I just got paid 1,000 $QR for checking out today's winner @qrcoindotfun, noice!`);
    ...
    const quoteCastUrl = "https://farcaster.xyz/qrcoindotfun/0xbb3a9fb0"; // Empty for now, add a real URL when needed
    if (quoteCastUrl) {
